                   ...
                   <div className={'mobile-body-container'}> 
                    ...
                    <div className={'mobile-footer-container'}>
                        {this.state.tabItem.map(data =>
                            <div key={data} className={this.state.selectedItem === data ?
                             'bottom-menu-item-selected-container' : 'bottom-menu-item-container'} 
                             onClick={this.setSelectedTab.bind(this, data)}>
                                <span className={this.state.selectedItem === data ? 
                                    'bottom-menu-selected-item-txt' : 'bottom-menu-item-txt'}>
                                        {data}</span>
                            </div>
                        )}
                    </div>
                    ...
                    <div id={'projects'} className={'projects-parent-container'}>
                        <div className={'skills-container'}>
                            <span className={'dashboard-skills-label'}>Projects</span>
                              ...
                              <span><p>Credentials:</p><h4>USER NAME: user OR EMAIL : dummy@gmail.com & PASSWORD : 123456</h4>
                            </span>
                        <ProjectsComponent />
